...
import {
    Box, Flex, Heading, HStack, Icon, Text, useDisclosure, VStack, AlertDialog,
    AlertDialogOverlay,
    AlertDialogContent,
    AlertDialogBody,
    AlertDialogHeader,
        ...
        <>
            {!currentPage ?
                ...
                >
                    ...
                    <Icon mt={5} as={BiSolidLogOut} onClick={()=> router.push("/caregiver")} boxSize={10} color={'purple.500'} _hover={{cursor:'pointer', opacity:0.7}}/>
                </Flex>
                :
                <RenderPage />}
            <AlertDialog
