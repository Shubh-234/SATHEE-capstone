    ...
    return (
        ...
        >
            ...
            <Text fontSize="lg" mb={8} color="gray.300" maxW={'800px'}>
                Sathee is a supportive companion for the elderly, offering an engaging environment through text and video-based interactions. Helping to alleviate loneliness and promote emotional health.
            </Text>
